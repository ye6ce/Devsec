...
export default function SchemaCard({ title, description, category, status = '', icon: Icon }) {
  return (
    <div className="w-full max-w-xs h-full flex flex-col items-center text-center relative overflow-hidden rounded-3xl bg-black/20 border border-white/10 backdrop-blur-sm group hover:border-white/30 transition-colors duration-500">
      ...
      <div className="p-6 relative z-10 w-full bg-gradient-to-t from-black/80 to-transparent">
