...
export default function FluidCursor({
  ...
  useEffect(() => {
    ...
    function generateColor(): ColorRGB {
      // Constant pink color #ff2d95 (normalized and scaled)
      return { r: 0.15, g: 0.026, b: 0.087 };
    }
  ...
  return (
    <div className={`pointer-events-none fixed top-0 left-0 z-50 h-full w-full ${className}`}>
